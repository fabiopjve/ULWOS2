...
#define CL_BRED             0XF81F
#define CL_GRED 			 0XFFE0
#define CL_GBLUE			 0X07FF
#define CL_RED           	 0xF800
#define CL_MAGENTA       	 0xF81F
#define CL_GREEN         	 0x07E0
#define CL_CYAN          	 0x7FFF
#define CL_YELLOW        	 0xFFE0
#define CL_BROWN 			 0XBC40 //brown
#define CL_BRRED 			 0XFC07 //maroon
#define CL_GRAY  			 0X8430 //gray
//GUI color
